...
##=========== START OF INPUTS ==========
cdmDatabaseSchema <- "cdm_mdcd_04172025.dbo" # The database / schema where the data in CDM format live
workDatabaseSchema <- "cdm_mdcd_04172025.results" # A database /schema where study tables can be written
