...
##=========== START OF INPUTS ==========
cdmDatabaseSchema <- "ohdsi_cumc_2025q2r1_deid.dbo" # The database / schema where the data in CDM format live
workDatabaseSchema <- "ohdsi_cumc_2025q2r1_deid.results" # A database /schema where study tables can be written
